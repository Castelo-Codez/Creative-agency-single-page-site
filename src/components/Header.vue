...
<template>
    <header role="banner" aria-label="header">
        <div aria-label="content wrapper" class="container">
            <a
                href="/index.html"
                role="link"
                ...
                >
                    ...
                    >
                        <g fill-rule="evenodd" opacity=".5">
                            <path
                                d="M2.222.808l16.97 16.97-1.414 1.414L.808 2.222z"
                            />
                            <path
                                d="M.808 17.778L17.778.808l1.414 1.414-16.97 16.97z"
                            />
                        </g>
                    </svg>
                </button>
